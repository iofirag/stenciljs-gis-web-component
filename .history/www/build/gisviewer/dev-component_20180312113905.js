        ...
        return h("div", { class: "dev-components" },
            ...
            h("div", { class: "body" },
                h("div", { class: "sideMenu" },
                    ...
                    h("input", { type: "button", value: "Change Units", onClick: e => this.testChangeUnits(e) }),
    ...
    createDevState() {
        ...
        const toolbarConfig = {
            ...
            toolbarPluginsConfig: {
                layersControllerConfig, fullScreenConfig, polylineMeasureConfig,
...
class GisViewer {
    ...
    static get properties() { return { "changeCoordinateSystem": { "method": true }, "changeUnits": { "method": true }, "gisViewerProps": { "type": "Any", "attr": "gis-viewer-props" } }; }
...
class MapContainer {
    ...
    render() {
        ...
        // this.coordinateSystem = this.gisViewerProps.mapConfig.coordinateSystem;
        return (h("div", null,
            h("tool-bar", { gisMap: this.gisMap, metric: this.metric, config: this.gisViewerProps.toolbarConfig }),
            _.get(this, "gisViewerProps.mapPluginsConfig.scaleControlConfig.enable") ? (h("scale-control-plugin", { gisMap: this.gisMap, config: this.gisViewerProps.mapPluginsConfig.scaleControlConfig, metric: this.metric })) : (""),
            ...
            _.get(this, "gisViewerProps.mapPluginsConfig.mouseCoordinateConfig.enable") ? (h("mouse-coordinate-plugin", { gisMap: this.gisMap, config: this.gisViewerProps.mapPluginsConfig.mouseCoordinateConfig, coordinateSystem: this.coordinateSystem })) : ("")));
    }
    componentDidLoad() {
        Utils.log_componentDidLoad(this.compName);
        const osmUrl = "http://{s}.tile.osm.org/{z}/{x}/{y}.png";
    ...
    static get properties() { return { "changeCoordinateSystem": { "method": true }, "changeUnits": { "method": true }, "coordinateSystem": { "state": true }, "gisMap": { "state": true }, "gisViewerProps": { "type": "Any", "attr": "gis-viewer-props" }, "metric": { "state": true } }; }
...
class ToolBar {
    ...
    render() {
        return (h("div", null,
            _.get(this, 'config.toolbarPluginsConfig.drawBarConfig.enable') ? (h("draw-bar-plugin", { gisMap: this.gisMap, config: this.config.toolbarPluginsConfig.drawBarConfig, metric: this.metric })) : (''),
    ...
    static get properties() { return { "config": { "type": "Any", "attr": "config" }, "gisMap": { "type": "Any", "attr": "gis-map" }, "metric": { "type": Boolean, "attr": "metric" } }; }
    static get style() { return ""; }
}
