...
/* Layers Controller */
export type LayersControllerConfig = {
    enable?: boolean,
...
export type ZoomToExtendConfig = {
    enable?: boolean,
...
/* Scale */
export type ScaleControlConfig = {
    enable?: boolean,
...
/* Mouse Coordinate */
export type MouseCoordinateConfig =  PluginConfig & {
    enable?: boolean,
...
/* Polyline Measure */
export type PolylineMeasureConfig = {
    enable?: boolean
...
/* Units Changer */
export type UnitsChangerConfig = {
    enable?: boolean
