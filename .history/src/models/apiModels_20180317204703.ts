...
export type ToolbarPluginsConfig = {
    layersControllerConfig?: LayersManagerConfig
...
// =========== Plugins =========
/* Layers Controller */
export type LayersManagerConfig = BasePluginConfig & {
    layersControllerOptions?: LayersManagerOptions
}
export type LayersManagerOptions = BaseControlOptions & {
}
