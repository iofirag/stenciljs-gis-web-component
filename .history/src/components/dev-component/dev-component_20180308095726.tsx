...
export class DevComponent {
  ...
  createDevState(): GisViewerProps {
    ...
    const layersController: LayersControllerConfig = {
      enable: true
    };

    const scaleControl: ScaleControlConfig = {
      enable: true,
      scaleControlOptions: {
    ...
    const searchBox: SearchBoxConfig = {
      enable: true,
      searchBoxOptions: {
        searchOnLayer: true,
        queryServerUrl:
    ...
    const zoomControl: ZoomControlConfig = {
      enable: true
    };

    const drawBar: DrawBarConfig = {
      enable: true,
      drawBarOptions: {
        draw: {
          polyline: true,
    ...
    const mouseCoordinate: MouseCoordinateConfig = {
      enable: true,
    ...
    const polylineMeasure: PolylineMeasureConfig = {
      enable: true,
    ...
    const zoomToExtendConfig: ZoomToExtendConfig = {
      enable: true,
      zoomToExtendOptions: {
        position: "topright"
      }
    ...
    const unitsChanger: UnitsChangerConfig = {
      enable: true
    };
