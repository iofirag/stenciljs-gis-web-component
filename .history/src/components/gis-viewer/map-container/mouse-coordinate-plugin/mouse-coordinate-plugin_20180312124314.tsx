...
import { MouseCoordinateConfig, CoordinateSystem, MouseCoordinateOptions } from "../../../../models/apiModels";
...
export class MouseCoordinagePlugin {
    ...
    @Prop() gisMap: L.Map;
    @Prop() coordinateSystemType: CoordinateSystem;
    ...
    componentDidLoad() {
        ...
        this.changeCoordinateSystemHandler(this.coordinateSystem)
