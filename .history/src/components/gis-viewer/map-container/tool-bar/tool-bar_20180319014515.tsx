...
import { TOOL_BAR_TAG, DRAW_BAR_PLUGIN_TAG, ZOOM_TO_EXTENT_PLUGIN_TAG, SEARCH_PLUGIN_TAG, MEASURE_PLUGIN_TAG, LAYERS_MANAGER_PLUGIN_TAG } from '../../../../utils/statics';
    ...
    private toolbarFeaturesDecision() {
        ...
        _.forEach(toolbarPlugins.children, (plugin: HTMLElement) => {
            ...
            if (plugin.tagName.toLowerCase() === DRAW_BAR_PLUGIN_TAG) {
                ...
                console.log(c,cc);
                // let drawBar: HTMLElement = plugin.getControl().getContainer().childNodes[0] as HTMLElement;
                //     // setting id for future styling purposes
                // drawBar.id = "draw-shapes-section";
            }
            console.log(plugin)
