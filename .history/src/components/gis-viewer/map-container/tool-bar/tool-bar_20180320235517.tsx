...
export class ToolBar {
    ...
    componentWillUpdate() {
        ...
        this.exportDropDownData = [{
            label: 'Export KML',
            onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.kml, {}, null, this.gisMap),
            className: 'icon-kml'
        }, {
            label: 'Export CSV',
                onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.csv, {}, null, this.gisMap),
            className: 'icon-csv'
        },
        {
            label: 'Export SHP',
            onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.zip, {}, null, this.gisMap),
            className: 'icon-shp'
        }
    }
