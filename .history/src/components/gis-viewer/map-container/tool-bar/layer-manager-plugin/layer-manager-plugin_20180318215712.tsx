...
export class layerManagerPlugin {
    ...
    componentDidLoad() {
        ...
        this.element = this.createPlugin();
        ...
        this.htmlBtElement.addEventListener("click", () => {
            this.toggleClassNamefromElement(this.element.getContainer(), "show");
    ...
    componentDidUnload() {
        ...
        this.gisMap.removeControl(this.element as L.Control);
    }
    ...
    private createElement(): L.Control {
        ...
        const baseMaps: any[] = [
            {
                groupName: "Base Maps",
                layers: null // this.context.mapState.baseMaps
            }
        ];

        c// onst mapState: MapState = this.context.mapState;
