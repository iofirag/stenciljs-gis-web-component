...
import { LAYERS_MANAGER_PLUGIN_TAG } from "../../../../../utils/statics";
// import { } from "../../../../../models/apiModels";
import Utils from "../../../../../utils/utilities";
import L from "leaflet";
import { LayersManagerConfig } from "../../../../../models/apiModels";
import _ from "lodash";


@Component({
    tag: 'layers-manager-plugin',
    styleUrls: [
...
export class layersManagerPlugin {
    compName: string = LAYERS_MANAGER_PLUGIN_TAG
    @Prop() config: LayersManagerConfig
    @Prop() gisMap: L.Map

    @State() control: L.Control;
    @State() htmlBtElement
    @State() createCustomLayerController: : HTMLElement;
    ...
    componentDidLoad() {
        ...
        this.createCustomLayerController = this.createCustomLayerController();
    ...
    private createCustomLayerController(): L.Control {
