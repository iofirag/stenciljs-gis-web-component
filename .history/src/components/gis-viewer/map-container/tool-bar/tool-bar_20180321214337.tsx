...
import { ToolbarConfig, DistanceUnitType, DropDownItemType } from '../../../../models';
            ...
            itemList: [
                {
                    ...
                    isSelected: this.config. .mapSettings.mode === 'cluster',
                },
            ]
        };
            ...
            <div>
                <layer-manager-plugin gisMap={this.gisMap} config={this.config.toolbarPluginsConfig.layerManagerConfig} />
                {
                    _.get(this, 'config.isSettings') ? (
                        <custom-drop-down-plugin gisMap={this.gisMap} dropDownData={settingsDropDownData} customControlName={'Export Map'} dropDownTitle={} />
                    ) : ('')
                }
                {
