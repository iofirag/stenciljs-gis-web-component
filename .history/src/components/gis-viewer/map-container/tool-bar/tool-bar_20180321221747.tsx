...
import { ToolbarConfig, DistanceUnitType, DropDownItemType, MouseCoordinateConfig, MapConfig, ClusterHeat } from '../../../../models';
                ...
                itemList: [
                    {
                        ...
                        name: 'layers',
                        type: DropDownItemType.RADIO_BUTTON,
                        isSelected: this.clusterHeatMode .mode === 'heat',
                    }, {
