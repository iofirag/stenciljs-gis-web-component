        ...
        return (
            <div>
                {/* {_.get(this, "config.toolbarPluginsConfig.drawBarConfig.enable") ? (
                    <draw-bar-plugin gisMap={this.gisMap} config={this.config.toolbarPluginsConfig.zoomToExtentConfig} metric={this.metric} />
                ) : (
                    ""
                )} */}
                <draw-bar-plugin gisMap={this.gisMap} config={this.config.toolbarPluginsConfig.drawBarConfig} metric={} />
