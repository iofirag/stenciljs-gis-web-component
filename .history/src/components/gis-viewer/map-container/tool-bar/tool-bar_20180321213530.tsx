...
import { TOOL_BAR_TAG, DRAW_BAR_PLUGIN_TAG, ZOOM_TO_EXTENT_PLUGIN_TAG, SEARCH_PLUGIN_TAG, MEASURE_PLUGIN_TAG, LAYER_MANAGER_PLUGIN_TAG, FULL_SCREEN_PLUGIN_TAG, FILE_TYPES, DROP_DOWN_PLUGIN_TAG, CUSTOM_DROP_DOWN_PLUGIN, CUSTOM_DROP_DOWN_PLUGIN_TAG } from '../../../../utils/statics';
import _ from 'lodash';
import { ToolbarConfig, DistanceUnitType } from '../../../../models';
...
export class ToolBar {
    ...
    private toolbarFeaturesDecision() {
        ...
        const controllerGroupMap = {
            ...
            [CUSTOM_DROP_DOWN_PLUGIN_TAG + '_' + CustomControlName.SETTINGS]: [controllerSettingsGroup],
        };
