...
export class ToolBar {
    ...
    render() {
        return (
            <div>
                {_.get(this, "config.toolbarConfig.toolbarPluginsConfig.drawBarConfig.enable") ? (
                    <draw-bar-plugin gisMap={this.gisMap} config={this.toolbarConfig.toolbarPluginsConfig.drawBarConfig} metric={this.metric} />
                ) : (
                    ""
                )}
