...
import * as measure from 'leaflet-linear-measure/examples/basic.ruler-src.js';
...
@Component({
    tag: 'measure-plugin1',
    styleUrls: [
        '../../../../../../node_modules/leaflet-linear-measure/examples/basic.ruler-src.css',
        './measure-plugin1.scss', 
    ]
})
