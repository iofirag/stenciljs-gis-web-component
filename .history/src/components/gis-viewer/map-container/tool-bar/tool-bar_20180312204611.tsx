    ...
    render() {
        return (
            <div>
                ...
                {
                    _.get(this, "config.toolbarPluginsConfig.polylineMeasureConfig.enable") ? (
                        <polyline-measure-plugin gisMap={this.gisMap} config={this.config.toolbarPluginsConfig.polylineMeasureConfig} distanceUnitType={this.distanceUnitType} />
                    ) : ('')
                }
            </div>
        );
