...
export class ToolBar {
    ...
    private toolbarFeaturesDecision() {
        ...
        let zoomToExtentPluginEl: HTMLDrawBarPluginElement = document.querySelector(`${ZOOM_TO_EXTENT_PLUGIN_TAG}`);
        ...
        // if (this.features[FeaturesNames.ZOOM_TO_EXTEND_COMP]) {
            ...
            Utils.stopDoubleClickOnPlugin(zoomToExtentPluginEl.drawControl._container);
        }
