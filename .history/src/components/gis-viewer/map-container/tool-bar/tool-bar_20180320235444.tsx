...
export class ToolBar {
    ...
    componentWillUpdate() {
        ...
        this.exportDropDownData = [{
            label: 'Export KML',
            onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.kml, {}, mapState, map, props.onSaveKmlBlob),
            className: 'icon-kml'
        }, {
            label: 'Export CSV',
                onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.csv, {}, mapState, map, props.onSaveCsvBlob),
            className: 'icon-csv'
        },
        {
            label: 'Export SHP',
            onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.zip, {}, mapState, map, props.onSaveShpBlob),
            className: 'icon-shp'
        }
    }
