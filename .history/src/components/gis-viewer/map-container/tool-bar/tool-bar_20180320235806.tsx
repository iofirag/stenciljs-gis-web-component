...
export class ToolBar {
    ...
    componentWillUpdate() {
        ...
        this.exportDropDownData = [{
            label: 'Export KML',
            onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.kml, {}, null, this.gisMap, 'onSaveKmlBlob'),
            className: 'icon-kml'
        }, {
            label: 'Export CSV',
            onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.csv, {}, null, this.gisMap, 'onSaveCsvBlob'),
            className: 'icon-csv'
        }, {
            label: 'Export SHP',
            onClick: Utils.exportBlobFactory.bind(this, FILE_TYPES.zip, {}, null, this.gisMap, 'onSaveShpBlob'),
            className: 'icon-shp'
        }];
    }
            ...
            <div>
                <layer-manager-plugin gisMap={this.gisMap} config={this.config.toolbarPluginsConfig.layerManagerConfig} />
                {
                    _.get(this, 'config.isExport') ? (
                        <drop-down-plugin gisMap={this.gisMap} config={this.config.toolbarPluginsConfig.drawBarConfig} dropDownData={this.exportDropDownData} dropDownTitle={'Export Map'} />
                    ) : ('')
                }
                {
