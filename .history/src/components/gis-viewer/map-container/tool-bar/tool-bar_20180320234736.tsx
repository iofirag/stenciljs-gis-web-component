    ...
    render() {
        return (
            <div>
                ...
                new DropDownComp(context, exportDropDownData, isImportExport, );
                {
                    _.get(this, 'config.isExport') ? (
                        <drop-down-plugin gisMap={this.gisMap} config={this.config.toolbarPluginsConfig.drawBarConfig} dropDownData={null} dropDownTitle={'Export Map'} />
                    ) : ('')
                }
                {
