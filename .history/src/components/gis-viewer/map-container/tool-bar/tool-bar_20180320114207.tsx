...
export class ToolBar {
    ...
    private toolbarFeaturesDecision() {
        ...
        const controllerGroupMaps = {
            controllerMapGroup: [LAYER_MANAGER_PLUGIN_TAG, ZOOM_TO_EXTENT_PLUGIN_TAG]
            controllerDrawGroup: [DRAW_BAR_PLUGIN_TAG, MEASURE_PLUGIN_TAG]
            controllerActionsGroup: [DRAW_BAR_PLUGIN_TAG, ]
            controllerSearchGroup: [SEARCH_PLUGIN_TAG]
            // [FeaturesNames.DROP_DOWN_COMP]: [controllerImportExportGroup],
            // [FeaturesNames.CUSTOM_DROP_DOWN_COMP + '_' + CustomControlName.SETTINGS]: [controllerSettingsGroup],
        };
