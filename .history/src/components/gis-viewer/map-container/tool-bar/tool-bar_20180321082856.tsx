...
import { TOOL_BAR_TAG, DRAW_BAR_PLUGIN_TAG, ZOOM_TO_EXTENT_PLUGIN_TAG, SEARCH_PLUGIN_TAG, MEASURE_PLUGIN_TAG, LAYER_MANAGER_PLUGIN_TAG, FULL_SCREEN_PLUGIN_TAG, FILE_TYPES, DROP_DOWN_PLUGIN_TAG } from '../../../../utils/statics';
        ...
        _.forEach(toolbarPlugins.children, (plugin: HTMLElement) => {
            ...
            switch(plugin.tagName.toLowerCase()) {
                ...
                case LAYER_MANAGER_PLUGIN_TAG: {
                    ...
                    let controlList: HTMLElement[] = controllerGroupMap[LAYER_MANAGER_PLUGIN_TAG];
                ...
                case DRAW_BAR_PLUGIN_TAG: {
                    ...
                    let controlList = controllerGroupMap[DRAW_BAR_PLUGIN_TAG];
                    controlList.forEach(cg => {
