...
import { TOOL_BAR_TAG, DRAW_BAR_PLUGIN_TAG, ZOOM_TO_EXTENT_PLUGIN_TAG, SEARCH_PLUGIN_TAG, MEASURE_PLUGIN_TAG } from '../../../../utils/statics';
...
export class ToolBar {
    ...
    private toolbarFeaturesDecision() {
        ...
        //     this.addFeatureToMap(drawBarLeafletElement);
            let drawBar: HTMLElement = drawBarPluginEl.drawControl.getContainer().childNodes[0] as HTMLElement;
        ...
        // if (this.features[FeaturesNames.ZOOM_TO_EXTEND_COMP]) {
            ...
            Utils.stopDoubleClickOnPlugin(zoomToExtentPluginEl.control.getContainer());
        }
        ...
        if (searchPluginEl) {
            ...
            // Stop double click on plugin
            Utils.stopDoubleClickOnPlugin(searchPluginEl.control.getContainer());
        }
        ...
        // if (this.features[FeaturesNames.MEASURE_COMP]) {
            ...
            const measure: HTMLElement = measurePluginEl.control.getContainer();
        ...
        _.forEach(toolbarEl.childNodes, (child: HTMLElement) => {
            console.log(child)
            debugger
        })
