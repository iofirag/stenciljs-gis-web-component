...
export class MeasurePlugin {
    ...
    private fromGlobalUnitToPlu(globalUnit: DistanceUnitType): string {
    ...
    private changePluginUnits(globalUnit: DistanceUnitType) {
        ...
        let pluginUnitOptions: string = this.pluginUnitOnButtonParser(globalUnit);
    ...
    private createPlugin(options: MeasureOptions): L.Control {
        ...
        const clonedOptions: any = Object.assign(
            ...
            { unit: this.this.distanceUnitType === 'km' ? METERS : IMPERIAL },
            options
        );
