...
import { TOOL_BAR_TAG, DRAW_BAR_PLUGIN_TAG, ZOOM_TO_EXTENT_PLUGIN_TAG, SEARCH_PLUGIN_TAG } from '../../../../utils/statics';
...
export class ToolBar {
    ...
    private toolbarFeaturesDecision() {
        ...
        // Measure
        let measurePluginEl: HTMLMeasurePluginElement = document.querySelector(`${SEARCH_PLUGIN_TAG}`);
        if (searchPluginEl) {
