        ...
        _.forEach(toolbarPlugins.children, (plugin: HTMLElement) => {
            ...
            switch(plugin.tagName.toLowerCase()) {
                ...
                case ZOOM_TO_EXTENT_PLUGIN_TAG:
                    container: HTMLElement = (plugin as HTMLZoomToExtentPluginElement).getControl().getContainer();
                ...
                case MEASURE_PLUGIN_TAG:
                    container: HTMLElement = (plugin as HTMLMeasurePluginElement).getControl().getContainer();
                ...
                case SEARCH_PLUGIN_TAG:    
                    container: HTMLElement = (plugin as HTMLSearchPluginElement).getControl().getContainer();
                    Utils.stopDoubleClickOnPlugin(container);
