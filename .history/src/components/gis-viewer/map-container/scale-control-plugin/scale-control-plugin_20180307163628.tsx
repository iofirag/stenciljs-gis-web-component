...
export class ScaleControlPlugin {
  ...
  validateMetric(newValue: boolean) {
    if (newValue) {
      /* Show Metric */
      this.toggleScaleElement('mi', false);  // Unhide mile
      this.toggleScaleElement('km', true); // Hide km
      // Hide mile
      ...
      this.toggleScaleElement('km', false); // Hide km
    }
  }

  public toggleScaleElement(unit: string, visibility: boolean) {
