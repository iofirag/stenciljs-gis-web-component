...
export class ScaleControlPlugin {
  ...
  private showScaleUnitsElementByType(globalDistanceUnitType: DistanceUnitType) { 
    this.setScaleUnitsElementVisibility('mi', 'mi' === this.fromg globalDistanceUnitType); // Hide mile
    this.setScaleUnitsElementVisibility('km', 'km' === globalDistanceUnitType);  // Show km
  }
