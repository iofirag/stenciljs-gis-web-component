...
export class ScaleControlPlugin {
  ...
  validateMetric(newValue: boolean) {
    if (newValue) {
      // Show Metric
      debugger
      let scaleMileElement: HTMLElement = document.querySelector('.leaflet-control-scale-line.mile');
      scaleMileElement.classList.add('hidden')
      let scaleMileElement: HTMLElement = document.querySelector('.leaflet-control-scale-line.km');
