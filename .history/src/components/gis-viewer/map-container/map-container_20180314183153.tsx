...
export class MapContainer {
  ...
  render() {
    return (
      <div>
        <tool-bar gisMap={this.gisMap} distanceUnitType={this.distanceUnitType} config={this.gisViewerProps.toolbarConfig} />

        {
          _.get(this, "gisViewerProps.mapPluginsConfig.scaleControlConfig.enable") ? (
          <scale-plugin gisMap={this.gisMap} config={this.gisViewerProps.mapPluginsConfig.scaleControlConfig} distanceUnitType={this.distanceUnitType}
          />
          ) : ('')
        }
