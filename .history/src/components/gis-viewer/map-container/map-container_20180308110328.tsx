...
export class MapContainer {
  ...
  @Prop() gisViewerProps: any//GisViewerProps;
  ...
  render() {
    return (
      <div>
        <tool-bar gisMap={this.gisMap} metric={this.metric} config={this.gisViewerProps.drawBarConfig, this.gisViewerProps.zoomT} drawBarConfig={this.gisViewerProps.drawBarConfig} />
