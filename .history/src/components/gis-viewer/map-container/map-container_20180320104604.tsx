...
import { MAP_CONTAINER_TAG, ZOOM_TO_EXTENT_PLUGIN_TAG } from '../../../utils/statics';
...
export class MapContainer {
  ...
  public createMap(): L.Map {
    ...
    // Zoom control
    extendedOptions.zoomControl = _.get(this.gisViewerProps.mapConfig.isZoomControl, 'props.zoomControl.enable', true);
