...
export class MiniMapPlugin {
  ...
  componentDidLoad() {
    ...
    // var minimapLayer = new MiniMap.TileLayer(osmUrl, { minZoom: 0, maxZoom: 13 });
    // console.log(minimapLayer, MiniMap)
    debugger
    this.minimapControl = new L.Control.MiniMap(null, { toggleDisplay: true });
    // this.minimapControl.addTo(this.gisMap);
    // this.gisMap.addControl(this.minimapYControl);
  }
