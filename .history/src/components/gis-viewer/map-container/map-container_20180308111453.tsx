...
export class MapContainer {
  ...
  componentWillLoad() {
    ...
    this.toolbarConfig = {drawBarConfig, zoomControlConfig, unitsChangerConfig, polylineMeasureConfig, fullScreenConfig, layersControllerConfig} = this.gisViewerProps;
    this.toolbarConfig = {
      drawBarConfig,
    }
  }
