...
import { GisViewerProps, CoordinateSystemType, DistanceType } from '../../../models/apiModels';
...
export class MapContainer {
  ...
  @State() distanceType: DistanceUnitType;
  ...
  changeUnits() {
    ...
    this.distanceType = coordinateSystemTypes[index];
  ...
  componentWillLoad() {
    ...
    this.isMetric = this.gisViewerProps.mapConfig.isMetric;
