...
export class MapContainer {
  ...
  componentWillLoad() {
    ...
    const {drawBarConfig, zoomControlConfig, unitsChangerConfig, polylineMeasureConfig, fullScreenConfig, layersControllerConfig} = this.gisViewerProps;
    this.toolbarConfig = {
      { drawBarConfig, zoomControlConfig, unitsChangerConfig, polylineMeasureConfig, fullScreenConfig, layersControllerConfig } = this.gisViewerProps;
    }
  }
  render() {
    return (
      <div>
        <tool-bar gisMap={this.gisMap} metric={this.metric} 
