...
export class MapContainer {
  ...
  componentWillLoad() {
    ...
    this.toolbarConfig = const {drawBarConfig, zoomControlConfig, unitsChangerConfig, polylineMeasureConfig, fullScreenConfig, layersControllerConfig} = this.gisViewerProps;
    this.toolbarConfig = {
      drawBarConfig,
    }
  }
