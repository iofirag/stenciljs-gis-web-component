...
export class MapContainer {
  ...
  render() {
    return (
      <div>
        <tool-bar gisMap={this.gisMap} metric={this.metric} config={this.gisViewerProps.drawBarConfig, this.gisViewerProps.} drawBarConfig={this.gisViewerProps.drawBarConfig} />
