...
export class ShapeManagerRepository {
	...
	public static getManagerByShapeId(id: string): ShapeManagerInterface {
		// Get type by id
		let type: ShapeType = ShapeManagerRepository.getTypeById(id);
		return ShapeManagerRepository.getManagerByType(type);
	}
	public static getTypeById(id: string): ShapeType {
		console.log(id);
		return null;
	}
