...
class MapContainer {
    ...
    changeCoordinateSystem() {
        ...
        index++;
        if (index === this.coordinateSystemType.length)
            index = 0;
    ...
    static get properties() { return { "changeCoordinateSystem": { "method": true }, "changeUnits": { "method": true }, "coordinateSystemType": { "state": true }, "gisMap": { "state": true }, "gisViewerProps": { "type": "Any", "attr": "gis-viewer-props" }, "metric": { "state": true } }; }
